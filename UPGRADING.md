...
Your facts, decisions, roadmap, progress, and daily notes are still your records. Do not treat the initializer as a blanket overwrite. There is no V1 `--force` option.
